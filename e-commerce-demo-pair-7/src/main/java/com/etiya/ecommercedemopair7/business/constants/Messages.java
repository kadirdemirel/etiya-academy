...
public class Messages {
    public static final String categoryCanNotExistWithSameName = "Bu isimle bir kategori zaten mevcut!";
    ...
    public static final String townNotFound = "İlgili ilçe bulanamadı.";
    public static final String userNotFound = "İlgili kullanıcı bulanamadı.";
    public static final String productCharNotFound = "İlgili karakteristik özellik bulunamadı.";
    public static final String districtNotFound = "İlgili mahalle bulunamadı.";
    public static final String deliveryOptionNotFound = "İlgili teslimat seçeneği bulanamadı.";
